...
| `post_backup_cmd`      |               no               | A command to run after backup, typically used to cleanup or restart an application                                                                                                                                                                                             |
...
| `schedule_weekday`     |            no (`*`)            | Weekday when the job is run.  ( 0-6 for Sunday-Saturday, *, etc )                                                                                                                                                             k                                                |
